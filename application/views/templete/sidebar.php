...
<li class="nav-item <?php echo $this->uri->segment(2) == '' ? 'active' : '' ?>" >
    <a class="nav-link" href="<?= base_url('penumpang') ?>">
...
<li class="nav-item  <?php echo $this->uri->segment(2) == 'kotaTujuan' ? 'active' : '' ?>" >
    <a class="nav-link collapsed" href="<?= base_url('penumpang/kotaTujuan'); ?>" >
...
<li class="nav-item  <?php echo $this->uri->segment(2) == 'reservasi' ? 'active' : '' ?>">
    <a class="nav-link collapsed" href="<?= base_url('penumpang/reservasi'); ?>" >
...
<li class="nav-item <?php echo $this->uri->segment(2) == 'pembayaran' ? 'active' : '' ?>">
    <a class="nav-link collapsed" href="<?= base_url('penumpang/pembayaran') ?>" >
